...
const HomeRentCard = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden max-w-sm">
      {/* <img src={image} alt="House" className="w-full object-cover" /> */}
      <motion.img 
        src={image} 
      ...
      />
      <div className="p-4">
        <button className="bg-blue-500 text-white px-2 py-1 rounded text-xs mb-2">
          {category}
        </button>
        ...
        <span className="float-end w-5 h-14">
          {" "}
          <CgArrowRight />
        </span>
      </div>
